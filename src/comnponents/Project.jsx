...
{project.map((data) => (
  <>
    ...
    <div className="card text-light" style={{width: "18rem", border:"2px solid orange", borderRadius:"10px", background: "rgb(9, 13, 41)", boxShadow: "5px 5px 20px 8px rgb(165, 42, 42,0.2)"}} data-aos="flip-right" data-aos-duration="1000">
